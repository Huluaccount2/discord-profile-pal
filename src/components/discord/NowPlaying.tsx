...
export const NowPlaying = ({ currentSong }: NowPlayingProps) => {
  ...
  return (
    <div className="bg-gradient-to-r from-green-900/20 to-green-800/20 border border-green-700/30 rounded-lg p-3 w-full h-full flex items-center">
      <div className="flex items-center gap-4 w-full">
        {/* Album Cover - smaller for compressed layout */}
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-2">
            ...
            <Headphones className="w-4 h-4 text-green-400 animate-pulse ml-auto" />
          </div>
          ...
          <div className="space-y-1">
            ...
            {currentSong.state && (
              <p className="text-gray-400 text-base truncate">{currentSong.state}</p>
            )}
